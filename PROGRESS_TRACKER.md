...
**Next up (Phase 7.6, not started):** multi-role permission architecture — the platform supports multiple partner roles per user already, but role-specific dashboards/switching/suspension and the full architecture the doc describes hasn't been verified against what's actually implemented.
