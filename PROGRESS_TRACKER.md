...
**Next up (Phase 7.4, not started):** custom tour requests & bidding — currently just title + free-text description + dates + a single headcount + budget range, with bids being price + message + a loose JSON itinerary blob. No structured adults/children/infants, no destination field, no stay/transport/food/accessibility/safety fields, and bids have no distinct price breakdown, taxes, deposit, or validity period.
